...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 10.73.3.4/16 | 10.73.0.1 |
...
| Ethernet5 | DC1-L2LEAF1A_Ethernet2 | *trunk | *110-111,114,120-121,130-131 | *- | *- | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 |  P2P_LINK_TO_DC1-SPINE01_Ethernet2  |  routed  | - |  172.31.255.5/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet2 |  P2P_LINK_TO_DC1-SPINE02_Ethernet2  |  routed  | - |  172.31.255.7/31  |  default  |  1500  |  false  |  -  |  -  |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC1-SPINE01_Ethernet2
   no shutdown
   no switchport
   ip address 172.31.255.5/31
!
interface Ethernet2
   description P2P_LINK_TO_DC1-SPINE02_Ethernet2
   no shutdown
   no switchport
