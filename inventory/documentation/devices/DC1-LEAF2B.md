...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 10.73.3.6/16 | 10.73.0.1 |
...
| Ethernet5 | DC1-L2LEAF2A_Ethernet2 | *trunk | *110-111,114,120-121,130-131 | *- | *- | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 |  P2P_LINK_TO_DC1-SPINE01_Ethernet4  |  routed  | - |  172.31.255.13/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet2 |  P2P_LINK_TO_DC1-SPINE02_Ethernet4  |  routed  | - |  172.31.255.15/31  |  default  |  1500  |  false  |  -  |  -  |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC1-SPINE01_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_DC1-SPINE02_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
| Port-Channel5 | DC1_L2LEAF2_Po1 | switched | trunk | 110-111,114,120-121,130-131 | - | - | - | - | 5 | - |
